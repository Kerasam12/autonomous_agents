...
class InternalState:
    ...
    def __init__(self):
        ...
        self.distance_from_astronaut = None
        self.last_time_astronaut_seen = [None, None]

        self.critter_location = None

        self.last_astronaut_location = None
    ...
    # Check the las time Agent ate a flower
    ...
    # Check where the obstacle is seen
    ...
    # Check where the astronaut is seen
    ...
    def get_astronaut_distance(self):
        return self.distance_from_astronaut
    
    def update_astronaut_distance(self, distance):
        self.distance_from_astronaut = distance
    
    def set_last_astronaut_direction(self, direction):
        self.last_astronaut_location = direction
    
    def update_last_astronaut_direction(self, location):
        self.last_time_astronaut_seen[0] = self.last_time_astronaut_seen[1]
        self.last_time_astronaut_seen[1] = location

    def get_last_astronaut_direction(self):
        return self.last_time_astronaut_seen


    # Check where the critter is seen
    def get_critter_location(self):
        return self.critter_location
    
    def locate_critter(self, location):
        self.critter_location = location
